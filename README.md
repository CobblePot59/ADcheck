...
Although textual, a simple color scheme is used to navigate through the returned information (:red_circle: red for really bad, :green_circle: green for okay, white for purely informative).
