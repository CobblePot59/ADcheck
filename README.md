...
Although textual, a simple color scheme is used to navigate through the returned information (<span style="color:red">red</span> for really bad, <span style="color:green">green</span> for okay, white for purely informative).
