CHECKLIST = {
    "LOW PRIVILEGE MODULES": [
        ...
        ("users_description", "Get Users with description"),
        ("bitlocker", "Computers with bitlocker keys"),
        ...
        ("domain_controlers", "Get Domain Controllers"),
        ("force_logoff", "Verify if Force logoff when logon hours expire"),
        ("functional_level", "Get Functional level of domain"),
        ("gMSA", "Get Group Managed Service Accounts"),
        ("gpo_by_ou", "Get Group Policy Object by Organizational Unit"),
        ("gpp_password", "Name of Group Policy containing a password"),
        ("kerberos_hardened", "Get Kerberos config"),
        ("krbtgt_encryption", "Get Supported Kerberos encryption algorithms"),
        ...
        ("password_policy", "Get Default password policy"),
        ("policies_ace", "Get Group policy folder/file rights"),
        ("pre2000_group", "Name of Pre-Windows 2000 Compatible Access group members"),
        ("priv_rights", "Get Privilege Rights (SeDebugPrivilege, SeBackupPrivilege, ...)"),
        ("privesc_group", "Get List of users in Privesc group"),
        ("pso", "Get Password Settings Object"),
        ("rbac", "Name of Computers with rbac"),
        ("recycle_bin", "Verify if Recycle Bin is enabled"),
        ("silos", "Get Authentication policy silos"),
    ...
    "\nHIGH PRIVILEGE MODULES (requires admin privs)": [
        ...
        ("control_delegations", "Get Control delegations by container"),
        ...
        ("reg_av", "Get Name of AMSI installed"),
